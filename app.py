...
"""
    ...
    with tab5:
        ...
        st.download_button("Descargar KMZ eje + secciones", kmz_bytes, file_name="hidrosed_eje_cauce_secciones_v6_curvas_opcionales.kmz", mime="application/vnd.google-earth.kmz")
        ...
        summary = {
            "modulo": "HidroSed Eje Cauce y Secciones v6 curvas opcionales",
...
st.caption("Eje útil obligatorio · DEM OpenTopography/manual · curvas de apoyo opcionales · visor sección por km · perfil 3D hidráulico progresiva-offset-cota")
